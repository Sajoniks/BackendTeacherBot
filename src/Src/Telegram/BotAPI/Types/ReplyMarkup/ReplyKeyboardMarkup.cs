    ...
    public class ReplyKeyboardMarkup : IReplyMarkup
    {
        public class Button
        {
            ...
            public class PollType
            {
                ...
                public static readonly PollType Quiz = new PollType()
                    { Type = Poll.Type.Quiz.ToString().ToLowerInvariant() };

                public static readonly PollType Regular = new PollType()
                    { Type = Poll.Type.Regular.ToString().ToLowerInvariant() };
            ...
            [JsonProperty("request_poll", NullValueHandling = NullValueHandling.Ignore)]
            public PollType RequestPollType { get; set; }
        ...
        [JsonProperty("resize_keyboard", NullValueHandling = NullValueHandling.Ignore)]
        private bool _resizeKeyboard;

        [JsonProperty("one_time_keyboard", NullValueHandling = NullValueHandling.Ignore)]
